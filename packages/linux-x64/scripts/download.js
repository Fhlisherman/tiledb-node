...
if (process.platform !== 'linux' || process.arch !== 'x64') {
  console.log('Skipping download: wrong platform (expected linux-x64)');
  process.exit(0);
}

const VERSION = '2.30.1';
const ASSET_NAME = `tiledb-linux-x86_64-${VERSION}-6ea48ca.tar.gz`;
...
const EXPECTED_HASH = "83dac85745d0c9fdcd07fe9deb4a0dce7cb59f9d13ee4002fc03c0ff67822546";
